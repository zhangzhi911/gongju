...
//        highPos = (176 + Math.abs(RandomUtil.randome(56,87)));
		
	//区码,0xB0,16~55一级汉字，56~87二级汉字
	...
	public static String generateChineseName(){
		...
		//  System.out.println(surname.length);
		  //通过数组的下标随机的获取姓氏
		String firtname= surname[RandomUtil.randome(0, surname.length-1)];
		//名字
		String lastname =randomChineseString(RandomUtil.randome(1, 2));
